...
export default class TotalerrorsChart extends Component {
    componentDidMount() {
        ...
        let chart = am4core.create("total-errors", am4charts.PieChart);
    ...
    render() {
        return (
            <div>
                <div id="total-errors" style={{ width: "100%", height: "200px" }} />
            </div>
        )
    }
}
