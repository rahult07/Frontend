...
export default class MediumseverityChart extends Component {
    componentDidMount() {
        ...
        let chart = am4core.create("medium-severity", am4charts.PieChart);
    ...
    render() {
        return (
            <div>
                <div id="medium-severity" style={{ width: "100%", height: "200px" }} />
            </div>
        )
    }
}
