...
export default class HighseverityChart extends Component {
    componentDidMount() {
        ...
        let chart = am4core.create("high-severity", am4charts.PieChart);
    ...
    render() {
        return (
            <div>
                <div id="high-severity" style={{ width: "100%", height: "200px" }} />
            </div>
        )
    }
}
